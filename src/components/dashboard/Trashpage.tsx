              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium text-yellow-900">
                    Items in trash still use storage space
                  </p>
                      ...
                      <td className="px-6 py-4">
                        <div className="text-sm text-gray-600">
                          ...
                          <p
                            className={cn(
                              "text-xs mt-0.5",
                              daysRemaining <= 7 ? "text-red-600" : "text-gray-500"
                            )}
                          >
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center justify-end gap-2">
                          <button
                            ...
                            className="px-3 py-1.5 bg-green-50 text-green-700 hover:bg-green-100 rounded-lg transition-colors flex items-center gap-1.5 text-sm font-medium"
                            title="Restore"
                          >
                          ...
                          <button
                            ...
                            className="px-3 py-1.5 bg-red-50 text-red-700 hover:bg-red-100 rounded-lg transition-colors flex items-center gap-1.5 text-sm font-medium"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {filteredFiles.map((file) => {
              ...
              return (
                <div
                  key={file.id}
                  className="bg-white rounded-xl border border-gray-200 p-4 hover:shadow-lg transition-all duration-200 group"
                >
                  ...
                  <div className="flex flex-col gap-2 pt-3 border-t border-gray-100">
                    <button
                      onClick={() => handleRestore(file.id)}
                      className="w-full px-3 py-2 bg-green-50 text-green-700 text-sm font-medium rounded-lg hover:bg-green-100 transition-colors flex items-center justify-center gap-2"
                    >
                      <RefreshCw className="h-3.5 w-3.5" />
                      Restore
                    </button>
                    <button
                      onClick={() => handlePermanentDelete(file.id, file.name)}
                      className="w-full px-3 py-2 bg-red-50 text-red-700 text-sm font-medium rounded-lg hover:bg-red-100 transition-colors flex items-center justify-center gap-2"
                    >
                      <X className="h-3.5 w-3.5" />
                      Delete Forever
                    </button>
        ...
        {filteredFiles.length === 0 && (
          <div className="text-center py-16">
            ...
            <p className="text-gray-600">
              {searchQuery ? "No items match your search" : "Deleted items will appear here"}
            </p>
          </div>
        )}
      </div>
